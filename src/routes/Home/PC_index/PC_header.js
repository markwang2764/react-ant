			...
			<header>
				<Row>
					...
					<Col span={16}>
						...
						<Modal title="用户中心" wrapclassNameName="vertical-center-modal" visible={this.state.modalVisible} onCancel= {()=>this.setModalVisible(false)} onOk={() => this.setModalVisible(false)} okText="关闭">
